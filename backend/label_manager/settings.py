"""
Django settings for label_manager project.
...
SECRET_KEY = 'django-insecure-&(m6=ukhj84f76w%6=^dz&r%*ygk399gv11vjk(e#2l&o=)2pp'
...
REST_FRAMEWORK = {
    ...
    # Temporarily allow all access for development testing
